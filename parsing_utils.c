...
/*   Updated: 2023/07/15 16:55:12 by yel-touk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_scene(t_scene_infn *scene)
{
	...
	scene->longest = 0;
	scene->minimap = 0;
	scene->no.img.img = NULL;
	scene->ea.img.img = NULL;
	scene->so.img.img = NULL;
	scene->we.img.img = NULL;
	scene->weapon1.img.img = NULL;
	scene->weapon2.img.img = NULL;
	scene->weapon3.img.img = NULL;
	while (++i < 7)
